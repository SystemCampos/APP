...
function opcionesAfectacionVentaCorta($selected='10'){
$items = caf_catalogo_js_activo($GLOBALS['idempresa'], true);
...
<div class="col-sm-12 borde mostrar" style="border-top:0px; display:none;">

<div class="row" >
<div class="col-sm-6  col-xs-6 form-group" >
<button type="button" class="btn btn-default form-control " onClick="BuscarArticulo()" id="agregar2_old" ><i class="fa fa-plus-square-o"></i> Agregar</button>
</div>
		
<div class="col-sm-6  col-xs-6 form-group" >
<button type="button" class="btn btn-default form-control" onClick="guardarventa(2)" id="guardar2_old" ><i class="fa fa-save"></i> Guardar</button>
</div>

<div class="col-sm-6  col-xs-6 form-group" >
<button type="button" class="btn btn-default form-control" id="imprimirt2_old" onclick="llenaimpresion()">
<i class="fa fa-print"></i> Imprimir Ticket</button>
</div>
<div class="col-sm-6  col-xs-6 form-group" >
<button type="button" class="btn btn-danger form-control" onClick="nuevo()"><i class="fa fa-times-circle"></i> Cancelar</button>
</div>
<div class="col-sm-6  col-xs-6 form-group" >
<button type="button" class="btn btn-success form-control" onClick="mostrarform(true, 0)"><i class="fa fa-plus-circle"></i> Nueva Venta</button>
</div>
</div>
...
<div class="col-xs-12">
  <!-- ===== MENU1: OTROS ATRIBUTOS (2 FILAS) ===== -->

  <!-- FILA 1 (4): ÁREA/C.COSTOS + Control Pres + Detracciones + MONTO DET. -->
  <div class="row" style="margin-top:-10px;">
    ...
    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-12">
      ...
      <div class="form-group">
        <select class="form-control" name="detracciones" onChange="totales()" id="detracciones" required style="width:100%; height:28px; font-size:11px; padding:3px 6px;">
    ...
    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
      <div class="form-group">
        <label>MONTO DET.:</label>
        <input type="text" id="montodetraccion" name="montodetraccion" readonly class="form-control" value="0.00"
               style="height:28px; font-size:11px; padding:3px 6px;" />
      </div>
    </div>
  </div>

  <!-- FILA 2 (6): Retenciones + MONTO RET. + Percepciones + MONTO PER. + Anticipos + Descontar stock -->
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12" style="padding-left:0px;">
      ...
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input type="text" id="serieanticipo" name="serieanticipo" readonly class="form-control" value=""
                 style="height:28px; font-size:11px; padding:3px 6px;" />
          <span class="input-group-btn oculto">
            <button class="btn btn-danger" id="anticipo" onClick="listardoc2()" type="button">
    ...
    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
      <div class="form-group">
        ...
        <select name="kardex" id="kardex" class="form-control" style="height:28px; font-size:11px; padding:3px 6px;">
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-12" style="margin-top:10px;">
                                            <fieldset>
                                                <button type="button" class="btn btn-primary" style="background:#337ab7;color:#fff;border-color:#2e6da4;" onClick="BuscarArticulo()" id="agregar2" ><i class="fa fa-plus-square"></i> Agregar Prod</button>
                                                <button type="button" class="btn btn-primary" style="background:#337ab7;color:#fff;border-color:#2e6da4;" onClick="Buscarserv()" id="agregars2" ><i class="fa fa-plus-square"></i> Agregar Serv</button>
                                                <button type="button" class="btn guardaventa" style="background:#000;border-color:#000;color:#fff;" onClick="guardarventa(2)" id="guardar2"><i class="fa fa-save"></i> Guardar</button>
                                                <button type="button" class="btn guardaventa" style="background:#000;border-color:#000;color:#fff;" onClick="guardarventa(1)" id="guardarenv2"><i class="fa fa-send"></i> Guardar Env.</button>
                                                <button type="button" class="btn btn-default" id="imprimir2" onClick="printPdf(1)"><i class="fa fa-print"></i> Imprimir</button>
                                                <button type="button" class="btn btn-default" id="imprimirt2" onclick="llenaimpresion()"><i class="fa fa-print"></i> Impr Ticket</button>
                                                <button type="button" class="btn btn-danger" onClick="cancelarform()" id="nuevo2"><i class="fa fa-times-circle"></i> Cancelar</button>
                                                <button type="button" class="btn btn-success" onClick="nuevo();mostrarform(true, 0)" id="nuevaventa2" disabled="disabled"><i class="fa fa-plus-circle"></i> Nueva Venta</button>
                                            </fieldset>
                                        </div>
                                    </div>
...
<input name="tarjeta" type=hidden id="tarjeta" value="0.00" />
                                  ...
                                  <tbody>
                                  <tr>
                                    <td style="width:23%; vertical-align:middle;">Descuento Global</td>
                                    <td style="width:27%;">
                                      <input type="text" name="descuentotot" id="descuentotot" value="0.00" style="height: 20px; text-align: right;" class="form-control" />
                                      <input type="hidden" name="dto_global_tipo" id="dto_global_tipo" value="MONTO" />
                                      <input type="hidden" name="dto_global_valor" id="dto_global_valor" value="0.0000" />
                                      <input type="hidden" name="dto_global_monto_base" id="dto_global_monto_base" value="0.00" />
                                      <input type="hidden" name="dto_global_monto_igv" id="dto_global_monto_igv" value="0.00" />
                                      <input type="hidden" name="dto_global_aplica_antes_igv" id="dto_global_aplica_antes_igv" value="1" />
                                    </td>
                                    <td style="width:23%;">Val.Ref</td>
                                    <td style="width:27%;"><input name="valref" type="text" id="valref" style="height: 20px;" value="0.00" class="form-control" readonly /></td>
                                  </tr>
                                  <tr>
                                    <td>Gravadas</td>
                                    <td><input type="text" id="gravadas" name="gravadas" class="form-control form-control-sm" disabled style="height: 20px;" value="0.00" readonly /></td>
                                    <td>PUNTOS</td>
                                    <td><input name="puntos" type="text" id="puntos" value="0.00" style="height: 20px; text-align: right;" class="form-control" readonly /></td>
                                  </tr>
                                  <tr>
                                    <td>SubTotal</td>
                                    <td><input type="text" id="txtSUB_TOTAL" name="txtSUB_TOTAL" class="form-control form-control-sm" style="height: 20px;" value="0.00" readonly /></td>
                                    <td>Comisión</td>
                                    <td><input type="text" name="comisiont" id="comisiont" value="0.00" style="height: 20px;" class="form-control" readonly /></td>
                                  </tr>
                                  <tr>
                                    <td>Exonerada</td>
                                    <td><input type="text" id="exoneradof" name="exoneradof" value="0.00" style="height: 20px;" class="form-control form-control-sm" readonly /></td>
                                    <td>Tot/Anticipo</td>
                                    <td><input type="text" name="totanticipo" id="totanticipo" value="0.00" style="height: 20px;" class="form-control" readonly /></td>
                                  </tr>
                                  <tr>
                                    <td>Inafecta</td>
                                    <td><input type="text" id="inafecta" name="inafecta" value="0.00" style="height: 20px;" class="form-control form-control-sm" readonly /></td>
                                    <td>Tot/Saldo</td>
                                    <td><input type="text" name="totsaldo" id="totsaldo" value="0.00" style="height: 20px;" class="form-control" readonly /></td>
                                  </tr>
                                  <tr>
                                    <td>Gratuitas</td>
                                    <td><input type="text" id="gratuita" name="gratuita" value="0.00" style="height: 20px;" class="form-control form-control-sm" readonly /></td>
                                    <td>Tot/Pagar</td>
                                    <td><input type="text" name="totpagar" id="totpagar" value="0.00" style="height: 20px;" class="form-control" readonly /></td>
                                  </tr>
                                  <tr>
                                    <td>IGV(18)%<input name="txtPORCENTAJE_IGV" type="hidden" id="txtPORCENTAJE_IGV" value="0.00" class="form-control" readonly /></td>
                                    <td><input type="text" id="txtIGV" name="txtIGV" style="height: 20px;" value="0.00" class="form-control" readonly /></td>
                                    <td></td>
                                    <td></td>
                                  </tr>
                                  <tr>
                                    <td>Total</td>
                                    <td><input name="txtTOTAL" type="text" id="txtTOTAL" style="height: 20px;" value="0.00" class="form-control" readonly /></td>
                                    <td></td>
                                    <td></td>
                                  </tr>
                                  </tbody>
...
<select name="igvservicio" id="igvservicio" class="form-control">
  <?= opcionesAfectacionVentaCorta('10'); ?>
</select>
</div>
...
<select name="igvoperacion" id="igvoperacion" class="form-control">
  <option value="20" selected="selected">EXONERADO (20)</option>
  <option value="10">IGV 18% (10)</option>
  <option value="30">INAFECTO (30)</option>
  <option value="11">Retiro premio (11)</option>
  <option value="12">Retiro donación (12)</option>
  <option value="13">Retiro gravado (13)</option>
  <option value="14">Retiro pub. (14)</option>
  <option value="15">Bonificación (15)</option>
  <option value="16">Retiro trab. (16)</option>
  <option value="21">Exon. trans. grat. (21)</option>
  <option value="31">Inaf. bonif. (31)</option>
  <option value="32">Inaf. retiro (32)</option>
  <option value="33">Inaf. muestra méd. (33)</option>
  <option value="34">Inaf. conv. col. (34)</option>
  <option value="35">Inaf. premio (35)</option>
  <option value="36">Inaf. pub. (36)</option>
</select>
</div>
...
<?php $catalogoAfectacionesVenta = caf_catalogo_js_activo($idempresa); ?>
<script>window.CATALOGO_AFECTACIONES_VENTA = <?= json_encode($catalogoAfectacionesVenta, JSON_UNESCAPED_UNICODE|JSON_UNESCAPED_SLASHES); ?>;</script>
<script type="text/javascript" src="scripts/venta.js?v=5"></script>
...
if(typeof _validarClienteSeleccion === 'function' && !_validarClienteSeleccion()){ return false; }
...
function _normAfectacionVentaInline(v){
    var s = String(v==null?'':v).trim();
    var m = s.match(/(?:^|[^0-9])(10|11|12|13|14|15|16|20|21|30|31|32|33|34|35|36)(?:[^0-9]|$)/);
    if(m && m[1]){ return m[1]; }
    if(['10','11','12','13','14','15','16','20','21','30','31','32','33','34','35','36'].indexOf(s)>=0){ return s; }
    if(s==='1'){ return '20'; }
    if(s==='2'){ return '35'; }
    if(s==='3'){ return '30'; }
    return '10';
...
function _tributoPorAfectacionInline(cod){
    var c = _normAfectacionVentaInline(cod);
    var def = {cod_tributo:'1000', porc_igv:'18.00', requiere_valor_referencial:0, codigo_tipo_precio:'01', es_gratuito:0};
    try{
        if(window.CATALOGO_AFECTACIONES_VENTA && window.CATALOGO_AFECTACIONES_VENTA.length){
            for(var i=0;i<window.CATALOGO_AFECTACIONES_VENTA.length;i++){
                var it = window.CATALOGO_AFECTACIONES_VENTA[i] || {};
                if(String(it.codigo||'')===c){
                    return {
                        cod_tributo:String(it.cod_tributo||'1000'),
                        porc_igv:(parseFloat(it.porcentaje_igv||0).toFixed(2)),
    ...
    if(['11','12','13','14','15','16','21','31','32','33','34','35','36'].indexOf(c)>=0){ return {cod_tributo:'9996', porc_igv:'18.00', requiere_valor_referencial:1, codigo_tipo_precio:'02', es_gratuito:1}; }
    if(c==='20'){ return {cod_tributo:'9997', porc_igv:'0.00', requiere_valor_referencial:0, codigo_tipo_precio:'01', es_gratuito:0}; }
    if(c==='30'){ return {cod_tributo:'9998', porc_igv:'0.00', requiere_valor_referencial:0, codigo_tipo_precio:'01', es_gratuito:0}; }
    if(c==='40'){ return {cod_tributo:'9995', porc_igv:'0.00', requiere_valor_referencial:0, codigo_tipo_precio:'01', es_gratuito:0}; }
    return def;
}
...
var codAfectacionDet = _normAfectacionVentaInline(($('#codafectacion'+idp).length ? $('#codafectacion'+idp).val() : exonerada));
var tribDet = _tributoPorAfectacionInline(codAfectacionDet);
// Mantener tipo legacy para compatibilidad con venta-graba2.php (0/1/2/3)
detalle["tipo"]=exonerada;
detalle["tipounidad"]=exonerada;
...
detalle["cod_tributo"]=tribDet.cod_tributo;
detalle["porc_igv"]=tribDet.porc_igv;
