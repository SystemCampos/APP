...
//($tipo_proceso, $ruc, $usuario_sol, $pass_sol, $ticket, $tipo_comprobante, $nro_comprobante)
$mensaje_cpe = cpeConsultaTicket($cab['TIPO_PROCESO'], $cab['NRO_DOCUMENTO_EMPRESA'], $cab['USUARIO_SOL_EMPRESA'], $cab['PASS_SOL_EMPRESA'], $cab['SUNAT'], $cab['TICKET'], $cab['TIPO_DOCUMENTO'], $cab['NRO_DOCUMENTO']);
