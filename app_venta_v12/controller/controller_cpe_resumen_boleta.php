...
if (file_exists($archivo)) {
   ...
   mkdir($archivo, 0755, true);
}

$mensaje_cpe = ResumenBoleta($cab['TIPO_PROCESO'], $cab['NRO_DOCUMENTO_EMPRESA'], $cab['USUARIO_SOL_EMPRESA'], $cab['PASS_SOL_EMPRESA'], $pin, $cab['SUNAT'], $cab, $detalle);
